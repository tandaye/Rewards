			...
			<nav class="navbar navbar-default" role="navigation">
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav">
						...
						<!-- 商品兑换 -->
						<li class="dropdown">
							<a href="${pageContext.request.contextPath}/article/findArticleList" class="dropdown-toggle" data-toggle="dropdown">商品兑换</a>
						</li>
						<!-- 商品兑换 结束-->
						...
						<!-- 订单查看 -->		
						<li class="dropdown grid">
							<a href="#" class="dropdown-toggle list1" data-toggle="dropdown">订单管理 </a>
						</li>
						<!-- 订单查看 结束-->	
