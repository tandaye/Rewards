...
<div class="admin-biaogelist">
    ...
    <div class="listbiaoti am-cf">
      ...
      <dl class="am-icon-home" style="float: right;"> 当前位置： 首页 > <a href="#">商品分类</a></dl>
 ...
 <div class="am-btn-toolbars am-btn-toolbar am-kg am-cf">
	 <form action="findTypeByOption" method="post">
	  <ul>
	    <li>
	      <div class="am-btn-group am-btn-group-xs">
	        <select id="type"  name="typeId" data-am-selected="{btnWidth: 90, btnSize: 'sm', btnStyle: 'default'}">
