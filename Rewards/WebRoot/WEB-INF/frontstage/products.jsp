...
<link href="${pageContext.request.contextPath}/resource/css/form.css" rel="stylesheet" type="text/css" media="all" />
<!-- js -->
...
<script type="text/javascript" src="${pageContext.request.contextPath}/resource/js/jquery.jscrollpane.min.js"></script>
...
<!-- //the jScrollPane script -->
<script type="text/javascript" src="${pageContext.request.contextPath}/resource/js/jquery.mousewheel.js"></script>
...
<body>
	...
	<div class="products">	 
		<div class="container">
			...
			<c:forEach items="${articlesList}" var="list">
			<!-- 商品 -->
			 
			<div class="product-grid">
					<a href="${pageContext.request.contextPath}/detail/articleDetail?id=${list.id}">				
						<div class="more-product"><span> </span></div>						
						  <div class="product-img b-link-stripe b-animate-go  thickbox">
					        <img src="${pageContext.request.contextPath}/resource/articleImg/${list.image}"  alt="">
							 <!-- <img src="upload/470a944b-55fd-4c3c-8326-d4f085e5fe1c.png" style="width:100px;height:100px;border-radius:100%" class="img1" /> -->
							<div class="b-wrapper">
					 ...
					 <div class="product-info simpleCart_shelfItem">
						<div class="product-info-cust prt_name">
							<h4>${list.name}</h4>								
							<span class="item_price">兑换所需积分：${list.exchangeScore}</span>
							<div class="ofr">
								<p class="pric1"><del>${list.exchangeScore+10}</del></p>
								<p class="disc">[15% Off]</p>
							</div>
							<input type="text" class="item_quantity" value="1" />
							<a href="detail/articleDetail?id=${list.id}"></a><input type="button" class="item_add items" value="兑换">
							</a>
							<div class="clearfix"> </div>
						</div>												
					</div>
