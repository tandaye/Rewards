...
<!-- cart -->
<script type="text/javascript" src="${pageContext.request.contextPath}/resource/js/address.js"></script>
</head>
<body>
	<!--header-->
	<div class="header">
	...
	<div class="cart-items">
		<div class="container">
			...
			<form action="OrderGeneration">
				<div class="close1"> </div>
				<div class="cart-sec simpleCart_shelfItem">
					<div class="cart-item cyc">
						 <img src="${pageContext.request.contextPath}/resource/articleImg/${article.image}"  alt="">
					</div>
					
					
					<div class="cart-item-info">
						<h3><span>商品名称:&nbsp;&nbsp;&nbsp;${article.name}</span></h3>
					
						<h3><span>所需积分:&nbsp;&nbsp;&nbsp;${article.exchangeScore}</span></h3>
						<div> 
						 <h3>地址:</h3> 
				 		<!-- 地址选择 --> 
		    		   ...
		    		   <script type="text/javascript">  
						...
						<input type="submit" class="item_add items" style="width: 200px;" value="确认兑换">
					</div>
			...
			<div class="cart-header2">
				...
				<div class="cart-sec simpleCart_shelfItem">
					<div class="cart-item cyc">
						 <img src="${pageContext.request.contextPath}/resource/images/m2.png" class="img-responsive" alt="">
					</div>
					<div class="cart-item-info">
			...
			<div class="cart-header3">
				...
				<div class="cart-sec simpleCart_shelfItem">
					<div class="cart-item cyc">
						 <img src="${pageContext.request.contextPath}/resource/images/m3.png" class="img-responsive" alt="">
					</div>
					<div class="cart-item-info">
						<h3><a href="#"> Lorem Ipsum is not simply </a><span>Pickup time:</span></h3>
						<ul class="qty">
	...
	<div class="footer-bottom">
		<div class="container">
			<p>Copyright &copy; 2015.Company name All rights reserved.More Templates <a href="http://www.cssmoban.com/" target="_blank" title="超哥哥">超哥哥版权所有</a> - Collect from <a href="http://www.cssmoban.com/" title="ç½é¡µæ¨¡æ¿" target="_blank">ç½é¡µæ¨¡æ¿</a></p>
		</div>
	</div>
</body>
</html>